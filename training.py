...
class TrainingObject:
    def __init__(self, dictionary, device, input_lang, output_lang, pairs, n_iters, print_every, plot_every,
        ...
        attn_decoder1 = AttnDecoderRNN(_device, _hidden_size, dictionary.output_lang.n_words, dropout_p=0.1).to(_device)

        for i in range(_epochs - 1):
            encoder1, attn_decoder1 = train_iters(device, input_lang, output_lang, pairs, encoder1, attn_decoder1,
